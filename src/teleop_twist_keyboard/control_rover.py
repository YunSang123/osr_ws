...
class RobotController(Node):
    def __init__(self):
        ...
        self.received_subscriber = self.create_subscription(
            Bool,
            '/tracking_ok',
        ...
        # 속도 비례 상수
        self.alpha = 1  # 선속도 감소율을 결정하는 상수
        self.max_lin_vel = 0.023  # 최대 선속도
        self.max_ang_vel = 0.025  # 최대 각속도
    ...
    def drive_robot(self):
        ...
        # 객체와 일정 거리를 유지함.
        elif(0.1 < self.distance <= self.goal_distance):
            twist = Twist()
            twist.linear.x = 0.0
            twist.angular.z = 0.0
            ...
            self.get_logger().info('Goal distance reached. Publishing is_goal_pub topic')
