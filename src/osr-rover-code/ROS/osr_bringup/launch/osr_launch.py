...
def generate_launch_description():
    ...
    ld.add_action(
        Node(
            ...
            output='screen',
            emulate_tty=True,
            parameters=[{'centered_pulse_widths': [90, 90, 92, 88]}] # pulse width where the corner motors are in their default position, see rover_bringup.md.
        ) # 165, 134, 145, 160 # rear_right, front_right, front_left, rear_left
    )
    ld.add_action(
